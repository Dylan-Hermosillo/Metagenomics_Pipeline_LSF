#!/bin/bash
#BSUB -R "span[hosts=1]"
#BSUB -o "${CONCOCT_LOGS_O_MEGA}/concoct.09A.%J_%I.log"
#BSUB -e "${CONCOCT_LOGS_E_MEGA}/concoct.09A.%J_%I.err"

# -------------------------
# 09A1_1_megahit_concoct.sh This script runs CONCOCT binning on MEGAHIT assembly
# -------------------------
...
SORTED_BAM="${ALIGN_MEGAHIT_DIR}/${NAME}/sorted.bam"
