#!/bin/bash
#BSUB -R "span[hosts=1]"
#BSUB -o "${CONCOCT_LOGS_O_META}/metaspades_concoct.09B.%J_%I.log"
#BSUB -e "${CONCOCT_LOGS_E_META}/metaspades_concoct.09B.%J_%I.err"

# -------------------------
# 09B_metaspades_concoct.sh This script runs CONCOCT binning on MEGAHIT assembly
# -------------------------
