#!/bin/bash
#BSUB -R "span[hosts=1]"
#BSUB -o "${CONCOCT_LOGS_O_MEGA}/megahit_concoct.09A.%J_%I.log"
#BSUB -e "${CONCOCT_LOGS_E_MEGA}/megahit_concoct.09A.%J_%I.err"

# -------------------------
# 09A_megahit_concoct.sh This script runs CONCOCT binning on MEGAHIT assembly
# -------------------------
